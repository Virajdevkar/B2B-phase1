...
const TransactionHistory = () => {
  ...
  const transactions = [
    { id: 1, senderName: 'John Doe', amount: 100, date: '2023-01-15', paymentMode: 'UPI' },
    { id: 2, senderName: 'Alice Smith', amount: 150, date: '2023-02-20', paymentMode: 'Cash' },
    { id: 3, senderName: 'Bob Johnson', amount: 75, date: '2023-03-10', paymentMode: 'UPI' },
        ...
        <tbody>
          {transactions.map((transaction) => (
            <tr key={transaction.id}>
              ...
              <td>
                <button onClick={() => showTransactionDetails(transaction)}>Show Details</button>
              </td>
            </tr>
          ))}
        </tbody>
